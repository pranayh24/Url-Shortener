  ...
  return (
    <div className="min-h-[calc(100vh-64px)] lg:px-14 sm:px-8 px-4">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              onClick={() => navigate('/manage-links')}
            >
              Manage Links
            </button>
            <button
              className="border-btnColor-border w-40 rounded-md py-2 px-4 hover:bg-btnColor"
      ...
      <div className="sm:pt-12 pt-7">
        <p className="text-slate-800 italic font-bold lg:w-[60%] md:w-[80%] mx-auto">
          Why Linklytics? Trusted by individuals and businesses worldwide
        </p>
